...
relation Instr_ok: `%|-%:%`(context, instr, functype)
  ...
  ;; 3-typing.watsup:281.1-283.27
  rule global.get {C : context, mf : mutflag, t : valtype, x : idx}:
    `%|-%:%`(C, GLOBAL.GET_instr(x), `%->%`([], [t]))
    -- if (C.GLOBAL_context[x] = `%%`(mf, t))

  ;; 3-typing.watsup:285.1-287.28
  rule global.set {C : context, t : valtype, x : idx}:
    `%|-%:%`(C, GLOBAL.SET_instr(x), `%->%`([t], []))
    -- if (C.GLOBAL_context[x] = `%%`(MUT_mutflag, t))
...
relation Global_ok: `%|-%:%`(context, global, globaltype)
  ...
  rule _ {C : context, expr : expr, gt : globaltype, mf : mutflag, t : valtype}:
    `%|-%:%`(C, GLOBAL(gt, expr), gt)
    -- Globaltype_ok: `|-%:OK`(gt)
    -- if (gt = `%%`(mf, t))
...
\mbox{(mutability flag)} & \mathit{mutflag} &::=& \mathsf{mut} ~|~ \mathsf{immut} \\
...
\begin{array}{@{}c@{}}\displaystyle
\frac{
\mathit{C}.\mathsf{global}[\mathit{x}] = \mathit{mf}~\mathit{t}
}{
...
\begin{array}{@{}c@{}}\displaystyle
\frac{
\mathit{C}.\mathsf{global}[\mathit{x}] = \mathsf{immut}~\mathit{t}
}{
