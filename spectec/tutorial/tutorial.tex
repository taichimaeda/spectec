...
First, declare some variables to use in validation rules as below:
\begin{lcverbatim}
var i : nat
var x : idx
var l : labelidx
...
\subsubsection{\K{Functype\_ok}}
\begin{lcverbatim}
rule Functype_ok:
  |- t_1* -> t_2? : OK
\end{lcverbatim}

\subsubsection{\K{Externtype\_ok/func}}
\begin{lcverbatim}
...
\subsubsection{\K{Functype\_sub}}
\begin{lcverbatim}
rule Functype_sub:
  |- ft <: ft
\end{lcverbatim}
  
\subsubsection{\K{Externtype\_sub/func}}
\begin{lcverbatim}
...
\subsubsection{\K{Instrs\_ok/seq}}
\begin{lcverbatim}
rule Instrs_ok/seq:
...
\subsubsection{\K{Instrs\_ok/frame}}
\begin{lcverbatim}
...
\subsubsection{\K{Instr\_ok/nop}}
\begin{lcverbatim}
rule Instr_ok/nop:
  C |- NOP : eps -> eps
\end{lcverbatim}

\subsubsection{\K{Instr\_ok/drop}}
\begin{lcverbatim}
rule Instr_ok/drop:
  C |- DROP : t -> eps
\end{lcverbatim}

\subsubsection{\K{Instr\_ok/select}}
\begin{lcverbatim}
rule Instr_ok/select:
  C |- SELECT : t t I32 -> t
\end{lcverbatim}

\subsubsection{\K{Instr\_ok/block}}
\begin{lcverbatim}
rule Instr_ok/block:
...
\subsubsection{\K{Instr\_ok/loop}}
\begin{lcverbatim}
rule Instr_ok/loop:
...
\subsubsection{\K{Instr\_ok/br\_if}}
\begin{lcverbatim}
rule Instr_ok/br_if:
  C |- BR_IF l : t? I32 -> t?
  -- if C.LABELS[l] = t?
...
\subsubsection{\K{Instr\_ok/call}}
\begin{lcverbatim}
rule Instr_ok/call:
  C |- CALL x : t_1* -> t_2?
...
\subsubsection{\K{Instr\_ok/return}}
\begin{lcverbatim}
...
\subsubsection{\K{Instr\_ok/const}}
\begin{lcverbatim}
rule Instr_ok/const:
  C |- CONST t c_t : eps -> t
\end{lcverbatim}

\subsubsection{\K{Instr\_ok/binop}}
\begin{lcverbatim}
rule Instr_ok/binop:
  C |- BINOP t binop_t : t t -> t
\end{lcverbatim}

\subsubsection{\K{Instr\_ok/local.get}}
\begin{lcverbatim}
...
\subsubsection{\K{Instr\_ok/local.set}}
\begin{lcverbatim}
...
\subsubsection{\K{Instr\_const/const}}
\begin{lcverbatim}
rule Instr_const/const:
  C |- (CONST t c) CONST
\end{lcverbatim}

\subsubsection{\K{Expr\_const}}
\begin{lcverbatim}
rule Expr_const:
  C |- instr* CONST
...
\subsubsection{\K{Expr\_ok\_const}}
\begin{lcverbatim}
rule Expr_ok_const:
  C |- expr : t? CONST
  -- Expr_ok: C |- expr : t?
...
\subsubsection{\K{Externidx\_ok/func}}
\begin{lcverbatim}
...
First, make a new file \K{4-reduction.wastup} and write as follows:
\begin{lcverbatim}
