...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:355.1-364.73 *)
Lemma t_read_preservation : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_val : (list val)) (v_valtype : (list valtype)) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Step_read (config__ (state__ v_s v_f) v_admininstr) v_admininstr') -> ((Store_ok v_s) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_val = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val v_valtype => (Val_ok v_val v_valtype)) (v_val) (v_valtype) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr (functype__ v_valtype_1 v_valtype_2)) -> (Admin_instrs_ok v_s v_C' v_admininstr' (functype__ v_valtype_1 v_valtype_2))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:366.1-378.74 *)
...
(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:381.1-385.45 *)
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:388.1-394.39 *)
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_block : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_instr : (list instr)) (v_t : (option valtype)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__BLOCK v_t v_instr)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((((v_t = None) /\ (v_n = 0)) \/ ((v_t <> None) /\ (v_n = 1))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_call : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CALL v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__CALL_ADDR (lookup_total (fun_funcaddr v_z) v_x))] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_call_addr : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_k : nat) (v_t : (list valtype)) (v_x : idx) (v_func : func) (v_mm : moduleinst) (v_t_2 : (option valtype)) (v_t_1 : (list valtype)) (v_instr : (list instr)) (v_f : frame) (v_n : n) (v_a : addr) (v_val : (list val)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' (@app _ (list__val__admininstr v_val) [(admininstr__CALL_ADDR v_a)]) v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_f = {| frame__LOCALS := (@app _ v_val (List.map (fun v_t => (fun_default_ v_t)) (v_t))); frame__MODULE := v_mm |}) -> ((v_func = (func__FUNC v_x (List.map (fun v_t => (local__LOCAL v_t)) (v_t)) v_instr)) -> ((v_n = (fun_optionSize v_t_2)) -> (((List.length v_t_1) = (List.length v_val)) -> (((lookup_total (fun_funcinst v_z) v_a) = {| funcinst__TYPE := (functype__ v_t_1 v_t_2); funcinst__MODULE := v_mm; funcinst__CODE := v_func |}) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__FRAME_ v_n v_f [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))])] v_ft))))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_call_indirect_call : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_a : addr) (v_x : idx) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) -> (((lookup_total (tableinst__REFS (fun_table v_z 0)) v_i) = (Some v_a)) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__CALL_ADDR v_a)] v_ft)))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_call_indirect_trap : forall (v_a : addr), forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((~ (((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) /\ ((lookup_total (tableinst__REFS (fun_table v_z 0)) v_i) = (Some v_a)))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_global_get : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__GLOBAL_GET v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [((globalinst__VALUE (fun_global v_z v_x)) : admininstr)] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_load_num_trap : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_mo : memop) (v_t : valtype) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ v_t None v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((((v_i + (memop__OFFSET v_mo)) + ((fun_size v_t) / 8)) > (List.length (meminst__BYTES (fun_mem v_z 0)))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_load_num_val : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_t : valtype) (v_c : val_) (v_mo : memop) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ v_t None v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_bytes v_t (v_c : val_)) = (list_slice (meminst__BYTES (fun_mem v_z 0)) (v_i + (memop__OFFSET v_mo)) ((fun_size v_t) / 8))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST v_t (v_c : val_))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_load_pack_trap : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_mo : memop) (v_sx : sx) (v_n : n) (v_inn : inn) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ (valtype__INN v_inn) (Some ((packsize__ v_n), v_sx)) v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((((v_i + (memop__OFFSET v_mo)) + (v_n / 8)) > (List.length (meminst__BYTES (fun_mem v_z 0)))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_load_pack_val : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_c : iN) (v_mo : memop) (v_sx : sx) (v_n : n) (v_inn : inn) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ (valtype__INN v_inn) (Some ((packsize__ v_n), v_sx)) v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_ibytes v_n v_c) = (list_slice (meminst__BYTES (fun_mem v_z 0)) (v_i + (memop__OFFSET v_mo)) (v_n / 8))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN v_inn) (fun_ext v_n (fun_size (valtype__INN v_inn)) v_sx v_c))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_local_get : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__LOCAL_GET v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [((fun_local v_z v_x) : admininstr)] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_loop : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_instr : (list instr)) (v_t : (option valtype)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__LOOP v_t v_instr)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((((v_t = None) /\ (v_n = 0)) \/ ((v_t <> None) /\ (v_n = 1))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__LABEL_ v_n [(instr__LOOP v_t v_instr)] (list__instr__admininstr v_instr))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:397.1-407.76 *)
Lemma Step_read__preserves_memory_size : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype_1 : (list valtype)) (v_val_1 : (list val)) (v_ft : functype) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype_1 (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__MEMORY_SIZE )] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((((v_n * 64) * (fun_Ki )) = (List.length (meminst__BYTES (fun_mem v_z 0)))) -> ((v_val_1 = (frame__LOCALS v_f)) -> (List.Forall2 (fun v_val_1 v_valtype_1 => (Val_ok v_val_1 v_valtype_1)) (v_val_1) (v_valtype_1) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_n : val_))] v_ft))))))).
Proof. Admitted.
