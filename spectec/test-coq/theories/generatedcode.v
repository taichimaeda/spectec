...
(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:239.1-240.32 *)
...
(* Mutual Recursion at: spec/wasm-1.0-test/A-soundness.watsup:244.1-245.41 *)
(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:244.1-245.41 *)
...
(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:250.1-251.44 *)
...
(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:256.1-257.44 *)
...
(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:262.1-263.38 *)
...
(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:271.1-276.53 *)
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:278.1-290.58 *)
Lemma t_progress_e : forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : (list val)) (v_admininstr : (list admininstr)) (v_ft : functype) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Admin_instrs_ok v_s v_C v_admininstr v_ft) -> ((v_ft = (functype__ v_valtype_1 v_valtype_2)) -> ((v_C = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (fun_types_of (frame__LOCALS v_f)); context__LABELS := []; context__RETURN := None |} ++ v_C')))) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_types_of v_val) = v_valtype_1) -> ((Store_ok v_s) -> ((fun_not_lf_br v_admininstr) -> ((fun_not_lf_return v_admininstr) -> ((fun_terminal_form (@app _ (list__val__admininstr v_val) v_admininstr)) \/ exists (v_s' : store) (v_f' : frame) (v_admininstr' : (list admininstr)), (Step (config__ (state__ v_s v_f) (@app _ (list__val__admininstr v_val) v_admininstr)) (config__ (state__ v_s' v_f') v_admininstr'))))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:292.1-304.52 *)
...
(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:306.1-308.24 *)
Theorem t_progress' : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_t : (option valtype)), ((Config_ok (config__ (state__ v_s v_f) v_admininstr) v_t) -> ((fun_terminal_form v_admininstr) \/ exists (v_s' : store) (v_f' : frame) (v_admininstr' : (list admininstr)), (Step (config__ (state__ v_s v_f) v_admininstr) (config__ (state__ v_s' v_f') v_admininstr')))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:315.1-317.39 *)
Lemma t_progress_e' : forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : (list val)) (v_admininstr : (list admininstr)) (v_ft : functype) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Admin_instrs_ok v_s v_C v_admininstr v_ft) -> ((v_ft = (functype__ v_valtype_1 v_valtype_2)) -> ((v_C = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (fun_types_of (frame__LOCALS v_f)); context__LABELS := []; context__RETURN := None |} ++ v_C')))) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_types_of v_val) = v_valtype_1) -> ((Store_ok v_s) -> ((fun_not_lf_br v_admininstr) -> ((fun_not_lf_return v_admininstr) -> ((fun_terminal_form (@app _ (list__val__admininstr v_val) v_admininstr)) \/ exists (v_s' : store) (v_f' : frame) (v_admininstr' : (list admininstr)), (Step (config__ (state__ v_s v_f) (@app _ (list__val__admininstr v_val) v_admininstr)) (config__ (state__ v_s' v_f') v_admininstr'))))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:331.1-333.39 *)
Lemma t_progress_be' : forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : (list val)) (v_instr : (list instr)) (v_ft : functype) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Instrs_ok v_C v_instr v_ft) -> ((v_ft = (functype__ v_valtype_1 v_valtype_2)) -> ((v_C = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (fun_types_of (frame__LOCALS v_f)); context__LABELS := []; context__RETURN := None |} ++ v_C')))) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_types_of v_val) = v_valtype_1) -> ((Store_ok v_s) -> ((fun_not_lf_br (list__instr__admininstr v_instr)) -> ((fun_not_lf_return (list__instr__admininstr v_instr)) -> ((fun_const_list (list__instr__admininstr v_instr)) \/ exists (v_s' : store) (v_f' : frame) (v_admininstr : (list admininstr)), (Step (config__ (state__ v_s v_f) (@app _ (list__val__admininstr v_val) (list__instr__admininstr v_instr))) (config__ (state__ v_s' v_f') v_admininstr))))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:347.1-353.49 *)
Lemma t_pure_preservation : forall (v_s : store) (v_mm : moduleinst) (v_admininstr : (list admininstr)) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_valtype : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)) (v_ft : functype), ((Module_instance_ok v_s v_mm v_C) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := v_valtype; context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr v_ft) -> ((Step_pure v_admininstr v_admininstr') -> (Admin_instrs_ok v_s v_C' v_admininstr' v_ft))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:355.1-367.73 *)
Lemma t_read_preservation : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_valtype : (list valtype)) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Step_read (config__ (state__ v_s v_f) v_admininstr) v_admininstr') -> ((Store_ok v_s) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr (functype__ v_valtype_1 v_valtype_2)) -> (Admin_instrs_ok v_s v_C' v_admininstr' (functype__ v_valtype_1 v_valtype_2)))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:369.1-384.74 *)
Lemma t_preservation_type : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_s' : store) (v_f' : frame) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_valtype : (list valtype)) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Step (config__ (state__ v_s v_f) v_admininstr) (config__ (state__ v_s' v_f') v_admininstr')) -> ((Store_ok v_s) -> ((Store_ok v_s') -> ((Store_extension v_s v_s') -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((Module_instance_ok v_s' (frame__MODULE v_f) v_C) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr (functype__ v_valtype_1 v_valtype_2)) -> (Admin_instrs_ok v_s' v_C' v_admininstr' (functype__ v_valtype_1 v_valtype_2))))))))))).
Proof. Admitted.

(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:387.1-391.45 *)
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_binop_val : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t : valtype) (v_c : val_) (v_binop : binop_) (v_c_2 : val_) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__CONST v_t (v_c_2 : val_));(admininstr__BINOP v_t (v_binop : binop_))] v_ft) -> ((Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__CONST v_t (v_c_2 : val_));(admininstr__BINOP v_t (v_binop : binop_))] [(admininstr__CONST v_t (v_c : val_))]) -> (((fun_binop v_t (v_binop : binop_) (v_c_1 : val_) (v_c_2 : val_)) = (Some (v_c : val_))) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_succ : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_admininstr : (list admininstr)) (v_l : labelidx) (v_val : (list val)) (v_instr : (list instr)) (v_n : n), ((Admin_instrs_ok v_s v_C [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__BR (v_l + 1))] v_admininstr)))] v_ft) -> ((Step_pure [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__BR (v_l + 1))] v_admininstr)))] (@app _ (list__val__admininstr v_val) [(admininstr__BR v_l)])) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_zero : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_n : n) (v_admininstr : (list admininstr)) (v_val : (list val)) (v_val' : (list val)) (v_instr : (list instr)), ((Admin_instrs_ok v_s v_C [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val') (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__BR 0)] v_admininstr))))] v_ft) -> ((Step_pure [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val') (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__BR 0)] v_admininstr))))] (@app _ (list__val__admininstr v_val) (list__instr__admininstr v_instr))) -> (((List.length v_val) = v_n) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_if_false : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_l : labelidx) (v_c : iN), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__BR_IF v_l)] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__BR_IF v_l)] []) -> (((v_c : val_) = 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_if_true : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_l : labelidx) (v_c : iN), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__BR_IF v_l)] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__BR_IF v_l)] [(admininstr__BR v_l)]) -> (((v_c : val_) <> 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_table_ge : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_l' : labelidx) (v_l : (list labelidx)) (v_i : nat), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__BR_TABLE v_l v_l')] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__BR_TABLE v_l v_l')] [(admininstr__BR v_l')]) -> ((v_i >= (List.length v_l)) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_br_table_lt : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_l' : labelidx) (v_l : (list labelidx)) (v_i : nat), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__BR_TABLE v_l v_l')] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__BR_TABLE v_l v_l')] [(admininstr__BR (lookup_total v_l v_i))]) -> ((v_i < (List.length v_l)) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_cvtop_trap : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t_1 : valtype) (v_sx : (option sx)) (v_cvtop : cvtop) (v_t_2 : valtype) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t_1 (v_c_1 : val_));(admininstr__CVTOP v_t_2 v_cvtop v_t_1 v_sx)] v_ft) -> ((Step_pure [(admininstr__CONST v_t_1 (v_c_1 : val_));(admininstr__CVTOP v_t_2 v_cvtop v_t_1 v_sx)] [(admininstr__TRAP )]) -> (((fun_cvtop v_t_1 v_t_2 v_cvtop v_sx (v_c_1 : val_)) = None) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_cvtop_val : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t_2 : valtype) (v_t_1 : valtype) (v_c : val_) (v_sx : (option sx)) (v_cvtop : cvtop) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t_1 (v_c_1 : val_));(admininstr__CVTOP v_t_2 v_cvtop v_t_1 v_sx)] v_ft) -> ((Step_pure [(admininstr__CONST v_t_1 (v_c_1 : val_));(admininstr__CVTOP v_t_2 v_cvtop v_t_1 v_sx)] [(admininstr__CONST v_t_2 (v_c : val_))]) -> (((fun_cvtop v_t_1 v_t_2 v_cvtop v_sx (v_c_1 : val_)) = (Some (v_c : val_))) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_drop : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_val : val), ((Admin_instrs_ok v_s v_C [(v_val : admininstr);(admininstr__DROP )] v_ft) -> ((Step_pure [(v_val : admininstr);(admininstr__DROP )] []) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_frame_vals : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_n : n) (v_val : (list val)) (v_f : frame), ((Admin_instrs_ok v_s v_C [(admininstr__FRAME_ v_n v_f (list__val__admininstr v_val))] v_ft) -> ((Step_pure [(admininstr__FRAME_ v_n v_f (list__val__admininstr v_val))] (list__val__admininstr v_val)) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_if_false : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_instr_2 : (list instr)) (v_instr_1 : (list instr)) (v_t : (option valtype)) (v_c : iN), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__IFELSE v_t v_instr_1 v_instr_2)] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__IFELSE v_t v_instr_1 v_instr_2)] [(admininstr__BLOCK v_t v_instr_2)]) -> (((v_c : val_) = 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_if_true : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_instr_2 : (list instr)) (v_instr_1 : (list instr)) (v_t : (option valtype)) (v_c : iN), ((Admin_instrs_ok v_s v_C [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__IFELSE v_t v_instr_1 v_instr_2)] v_ft) -> ((Step_pure [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__IFELSE v_t v_instr_1 v_instr_2)] [(admininstr__BLOCK v_t v_instr_1)]) -> (((v_c : val_) <> 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_label_vals : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_val : (list val)) (v_instr : (list instr)) (v_n : n), ((Admin_instrs_ok v_s v_C [(admininstr__LABEL_ v_n v_instr (list__val__admininstr v_val))] v_ft) -> ((Step_pure [(admininstr__LABEL_ v_n v_instr (list__val__admininstr v_val))] (list__val__admininstr v_val)) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_local_tee : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_x : idx) (v_val : val), ((Admin_instrs_ok v_s v_C [(v_val : admininstr);(admininstr__LOCAL_TEE v_x)] v_ft) -> ((Step_pure [(v_val : admininstr);(admininstr__LOCAL_TEE v_x)] [(v_val : admininstr);(v_val : admininstr);(admininstr__LOCAL_SET v_x)]) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_relop : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t : valtype) (v_c : iN) (v_relop : relop_) (v_c_2 : val_) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__CONST v_t (v_c_2 : val_));(admininstr__RELOP v_t (v_relop : relop_))] v_ft) -> ((Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__CONST v_t (v_c_2 : val_));(admininstr__RELOP v_t (v_relop : relop_))] [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_))]) -> (((v_c : val_) = (fun_relop v_t (v_relop : relop_) (v_c_1 : val_) (v_c_2 : val_))) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_return_frame : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_n : n) (v_admininstr : (list admininstr)) (v_val : (list val)) (v_val' : (list val)) (v_f : frame), ((Admin_instrs_ok v_s v_C [(admininstr__FRAME_ v_n v_f (@app _ (list__val__admininstr v_val') (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__RETURN )] v_admininstr))))] v_ft) -> ((Step_pure [(admininstr__FRAME_ v_n v_f (@app _ (list__val__admininstr v_val') (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__RETURN )] v_admininstr))))] (list__val__admininstr v_val)) -> (((List.length v_val) = v_n) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_return_label : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_admininstr : (list admininstr)) (v_val : (list val)) (v_instr : (list instr)) (v_n : n), ((Admin_instrs_ok v_s v_C [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__RETURN )] v_admininstr)))] v_ft) -> ((Step_pure [(admininstr__LABEL_ v_n v_instr (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__RETURN )] v_admininstr)))] (@app _ (list__val__admininstr v_val) [(admininstr__RETURN )])) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_select_false : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_c : iN) (v_val_2 : val) (v_val_1 : val), ((Admin_instrs_ok v_s v_C [(v_val_1 : admininstr);(v_val_2 : admininstr);(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__SELECT )] v_ft) -> ((Step_pure [(v_val_1 : admininstr);(v_val_2 : admininstr);(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__SELECT )] [(v_val_2 : admininstr)]) -> (((v_c : val_) = 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_select_true : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_c : iN) (v_val_2 : val) (v_val_1 : val), ((Admin_instrs_ok v_s v_C [(v_val_1 : admininstr);(v_val_2 : admininstr);(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__SELECT )] v_ft) -> ((Step_pure [(v_val_1 : admininstr);(v_val_2 : admininstr);(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_));(admininstr__SELECT )] [(v_val_1 : admininstr)]) -> (((v_c : val_) <> 0) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_testop : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t : valtype) (v_c : iN) (v_testop : testop_) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__TESTOP v_t (v_testop : testop_))] v_ft) -> ((Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__TESTOP v_t (v_testop : testop_))] [(admininstr__CONST (valtype__INN (inn__I32 )) (v_c : val_))]) -> (((v_c : val_) = (fun_testop v_t (v_testop : testop_) (v_c_1 : val_))) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_trap_frame : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_f : frame) (v_n : n), ((Admin_instrs_ok v_s v_C [(admininstr__FRAME_ v_n v_f [(admininstr__TRAP )])] v_ft) -> ((Step_pure [(admininstr__FRAME_ v_n v_f [(admininstr__TRAP )])] [(admininstr__TRAP )]) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_trap_label : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_instr : (list instr)) (v_n : n), ((Admin_instrs_ok v_s v_C [(admininstr__LABEL_ v_n v_instr [(admininstr__TRAP )])] v_ft) -> ((Step_pure [(admininstr__LABEL_ v_n v_instr [(admininstr__TRAP )])] [(admininstr__TRAP )]) -> (Admin_instrs_ok v_s v_C [] v_ft))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_trap_vals : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_admininstr : (list admininstr)) (v_val : (list val)), ((Admin_instrs_ok v_s v_C (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__TRAP )] v_admininstr)) v_ft) -> ((Step_pure (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__TRAP )] v_admininstr)) [(admininstr__TRAP )]) -> (((v_val <> []) \/ (v_admininstr <> [])) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_unop_trap : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t : valtype) (v_unop : unop_) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__UNOP v_t (v_unop : unop_))] v_ft) -> ((Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__UNOP v_t (v_unop : unop_))] [(admininstr__TRAP )]) -> (((fun_unop v_t (v_unop : unop_) (v_c_1 : val_)) = None) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:394.1-400.39 *)
Lemma Step_pure__preserves_unop_val : forall (v_ft : functype) (v_C : context) (v_s : store), forall (v_t : valtype) (v_c : val_) (v_unop : unop_) (v_c_1 : val_), ((Admin_instrs_ok v_s v_C [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__UNOP v_t (v_unop : unop_))] v_ft) -> ((Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__UNOP v_t (v_unop : unop_))] [(admininstr__CONST v_t (v_c : val_))]) -> (((fun_unop v_t (v_unop : unop_) (v_c_1 : val_)) = (Some (v_c : val_))) -> (Admin_instrs_ok v_s v_C [] v_ft)))).
Proof. Admitted.
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_block : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_instr : (list instr)) (v_t : (option valtype)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__BLOCK v_t v_instr)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((((v_t = None) /\ (v_n = 0)) \/ ((v_t <> None) /\ (v_n = 1))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_call : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CALL v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__CALL_ADDR (lookup_total (fun_funcaddr v_z) v_x))] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_call_addr : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_k : nat) (v_t : (list valtype)) (v_x : idx) (v_func : func) (v_mm : moduleinst) (v_t_2 : (option valtype)) (v_t_1 : (list valtype)) (v_instr : (list instr)) (v_f : frame) (v_n : n) (v_a : addr) (v_val : (list val)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' (@app _ (list__val__admininstr v_val) [(admininstr__CALL_ADDR v_a)]) v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((v_f = {| frame__LOCALS := (@app _ v_val (List.map (fun v_t => (fun_default_ v_t)) (v_t))); frame__MODULE := v_mm |}) -> ((v_func = (func__FUNC v_x (List.map (fun v_t => (local__LOCAL v_t)) (v_t)) v_instr)) -> ((v_n = (fun_optionSize v_t_2)) -> (((List.length v_t_1) = (List.length v_val)) -> (((lookup_total (fun_funcinst v_z) v_a) = {| funcinst__TYPE := (functype__ v_t_1 v_t_2); funcinst__MODULE := v_mm; funcinst__CODE := v_func |}) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__FRAME_ v_n v_f [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))])] v_ft))))))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_call_indirect_call : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_a : addr) (v_x : idx) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) -> (((lookup_total (tableinst__REFS (fun_table v_z 0)) v_i) = (Some v_a)) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__CALL_ADDR v_a)] v_ft)))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_call_indirect_trap : forall (v_a : addr), forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((~ (((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) /\ ((lookup_total (tableinst__REFS (fun_table v_z 0)) v_i) = (Some v_a)))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_global_get : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__GLOBAL_GET v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [((globalinst__VALUE (fun_global v_z v_x)) : admininstr)] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_load_num_trap : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_mo : memop) (v_t : valtype) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ v_t None v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((((v_i + (memop__OFFSET v_mo)) + ((fun_size v_t) / 8)) > (List.length (meminst__BYTES (fun_mem v_z 0)))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_load_num_val : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_t : valtype) (v_c : val_) (v_mo : memop) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ v_t None v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (((fun_bytes v_t (v_c : val_)) = (list_slice (meminst__BYTES (fun_mem v_z 0)) (v_i + (memop__OFFSET v_mo)) ((fun_size v_t) / 8))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST v_t (v_c : val_))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_load_pack_trap : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_mo : memop) (v_sx : sx) (v_n : n) (v_inn : inn) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ (valtype__INN v_inn) (Some ((packsize__ v_n), v_sx)) v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((((v_i + (memop__OFFSET v_mo)) + (v_n / 8)) > (List.length (meminst__BYTES (fun_mem v_z 0)))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__TRAP )] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_load_pack_val : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_c : iN) (v_mo : memop) (v_sx : sx) (v_n : n) (v_inn : inn) (v_i : nat) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__LOAD_ (valtype__INN v_inn) (Some ((packsize__ v_n), v_sx)) v_mo)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (((fun_ibytes v_n v_c) = (list_slice (meminst__BYTES (fun_mem v_z 0)) (v_i + (memop__OFFSET v_mo)) (v_n / 8))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN v_inn) (fun_ext v_n (fun_size (valtype__INN v_inn)) v_sx v_c))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_local_get : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_x : idx) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__LOCAL_GET v_x)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [((fun_local v_z v_x) : admininstr)] v_ft)))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_loop : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_instr : (list instr)) (v_t : (option valtype)) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__LOOP v_t v_instr)] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((((v_t = None) /\ (v_n = 0)) \/ ((v_t <> None) /\ (v_n = 1))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__LABEL_ v_n [(instr__LOOP v_t v_instr)] (list__instr__admininstr v_instr))] v_ft))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:403.1-416.76 *)
Lemma Step_read__preserves_memory_size : forall (v_ret : (option resulttype)) (v_lab : (list resulttype)) (v_valtype : (list valtype)) (v_ft : functype) (v_z : state) (v_C' : context) (v_C : context) (v_f : frame) (v_s : store), forall (v_n : n) (v_z : state), ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' [(admininstr__MEMORY_SIZE )] v_ft) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((v_z = (state__ v_s v_f)) -> ((((v_n * 64) * (fun_Ki )) = (List.length (meminst__BYTES (fun_mem v_z 0)))) -> (forall (v_i : nat), ((v_i < (List.length (frame__LOCALS v_f))) -> ((v_i < (List.length v_valtype)) -> (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)))) -> (Admin_instrs_ok v_s v_C' [(admininstr__CONST (valtype__INN (inn__I32 )) (v_n : val_))] v_ft))))))).
Proof. Admitted.
