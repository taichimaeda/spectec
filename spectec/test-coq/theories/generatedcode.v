...
Definition fun_not_lf_br (v___0 : (list admininstr)) : Prop :=
	match (v___0) with
		| (v_admininstr) => forall (v_val : val) (v_l : labelidx) (v_admininstr' : admininstr), (v_admininstr <> (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__BR v_l)] v_admininstr')))
	end.
...
Definition fun_not_lf_return (v___0 : (list admininstr)) : Prop :=
	match (v___0) with
		| (v_admininstr) => forall (v_val : val) (v_l : labelidx) (v_admininstr' : admininstr), (v_admininstr <> (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__RETURN )] v_admininstr')))
	end.
...
Theorem t_progress : forall (v_s : store) (v_f : frame) (v_admininstr : admininstr) (v_t : valtype), forall (v_s : store) (v_f : frame) (v_admininstr : admininstr) (v_t : valtype), ((Config_ok (config__ (state__ v_s v_f) v_admininstr) v_t) -> ((fun_terminal_form v_admininstr) \/ forall (v_s' : store) (v_f' : frame) (v_admininstr' : admininstr) (v_s : store) (v_f : frame) (v_admininstr : admininstr), (Step (config__ (state__ v_s v_f) v_admininstr) (config__ (state__ v_s' v_f') v_admininstr')))).
 Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:272.1-283.62 *)
Lemma t_progress_e : forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : val) (v_admininstr : admininstr) (v_ft : functype) (v_valtype_1 : valtype) (v_valtype_2 : valtype) (v_lab : valtype) (v_ret : valtype), forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : val) (v_admininstr : admininstr) (v_ft : functype) (v_valtype_1 : valtype) (v_valtype_2 : valtype) (v_lab : valtype) (v_ret : valtype), ((Admin_instrs_ok v_s v_C v_admininstr v_ft) -> ((v_ft = (functype__ v_valtype_1 v_valtype_2)) -> ((v_C = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := (Some (Some v_ret)) |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := [(Some v_lab)]; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (fun_types_of (frame__LOCALS v_f)); context__LABELS := []; context__RETURN := None |} ++ v_C')))) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_types_of v_val) = v_valtype_1) -> ((Store_ok v_s) -> ((fun_not_lf_br v_admininstr) -> ((fun_not_lf_return v_admininstr) -> ((fun_terminal_form (@app _ (list__val__admininstr v_val) v_admininstr)) \/ forall (v_s' : store) (v_f' : frame) (v_admininstr' : admininstr) (v_s : store) (v_f : frame) (v_val : val) (v_admininstr : admininstr), (Step (config__ (state__ v_s v_f) (@app _ (list__val__admininstr v_val) v_admininstr)) (config__ (state__ v_s' v_f') v_admininstr'))))))))))).
 Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:285.1-296.56 *)
Lemma t_progress_be : forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : val) (v_instr : instr) (v_ft : functype) (v_valtype_1 : valtype) (v_valtype_2 : valtype) (v_lab : valtype) (v_ret : valtype), forall (v_s : store) (v_C : context) (v_C' : context) (v_f : frame) (v_val : val) (v_instr : instr) (v_ft : functype) (v_valtype_1 : valtype) (v_valtype_2 : valtype) (v_lab : valtype) (v_ret : valtype), ((Instrs_ok v_C v_instr v_ft) -> ((v_ft = (functype__ v_valtype_1 v_valtype_2)) -> ((v_C = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := (Some (Some v_ret)) |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := [(Some v_lab)]; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (fun_types_of (frame__LOCALS v_f)); context__LABELS := []; context__RETURN := None |} ++ v_C')))) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (((fun_types_of v_val) = v_valtype_1) -> ((Store_ok v_s) -> ((fun_not_lf_br (list__instr__admininstr v_instr)) -> ((fun_not_lf_return (list__instr__admininstr v_instr)) -> ((fun_const_list (list__instr__admininstr v_instr)) \/ forall (v_s' : store) (v_f' : frame) (v_admininstr : admininstr) (v_s : store) (v_f : frame) (v_val : val) (v_instr : instr), (Step (config__ (state__ v_s v_f) (@app _ (list__val__admininstr v_val) (list__instr__admininstr v_instr))) (config__ (state__ v_s' v_f') v_admininstr))))))))))).
 Proof. Admitted.

(* Auxiliary Definition at: spec/wasm-1.0-test/A-soundness.watsup:299.1-299.34 *)
Definition fun_is_const2 (v_admininstr_0 : admininstr) : bool :=
	match (v_admininstr_0) with
		| ((admininstr__CONST v_valtype v_val_)) => true
		| (v_admininstr) => false
	end.
