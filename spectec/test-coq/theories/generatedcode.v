...
Inductive Instr_ok: context -> instr -> functype -> Prop :=
	...
	| Instr_ok__br : forall (v_C : context) (v_l : labelidx) (v_t_1 : (list valtype)) (v_t : (option valtype)) (v_t_2 : (list valtype)), (v_l < (List.length (context__LABELS v_C))) /\ (v_t = (lookup_total (context__LABELS v_C) v_l)) -> Instr_ok v_C (instr__BR v_l) (functype__ (@app _ v_t_1 v_t) v_t_2)
	| Instr_ok__br_if : forall (v_C : context) (v_l : labelidx) (v_t : (option valtype)), (v_l < (List.length (context__LABELS v_C))) /\ (v_t = (lookup_total (context__LABELS v_C) v_l)) -> Instr_ok v_C (instr__BR_IF v_l) (functype__ (@app _ v_t [(valtype__INN (inn__I32 ))]) v_t)
	| Instr_ok__br_table : forall (v_C : context) (v_l : (list labelidx)) (v_l' : labelidx) (v_t_1 : (list valtype)) (v_t : (option valtype)) (v_t_2 : (list valtype)), (v_l' < (List.length (context__LABELS v_C))) /\ List.Forall (fun v_l => (v_l < (List.length (context__LABELS v_C)))) (v_l) /\ List.Forall (fun v_l => (v_t = (lookup_total (context__LABELS v_C) v_l))) (v_l) /\ (v_t = (lookup_total (context__LABELS v_C) v_l')) -> Instr_ok v_C (instr__BR_TABLE v_l v_l') (functype__ (@app _ v_t_1 (@app _ v_t [(valtype__INN (inn__I32 ))])) v_t_2)
	| Instr_ok__call : forall (v_C : context) (v_x : idx) (v_t_1 : (list valtype)) (v_t_2 : (option valtype)), (v_x < (List.length (context__FUNCS v_C))) /\ ((functype__ v_t_1 v_t_2) = (lookup_total (context__FUNCS v_C) v_x)) -> Instr_ok v_C (instr__CALL v_x) (functype__ v_t_1 v_t_2)
	| Instr_ok__call_indirect : forall (v_C : context) (v_x : idx) (v_t_1 : (list valtype)) (v_t_2 : (option valtype)), (v_x < (List.length (context__TYPES v_C))) /\ ((functype__ v_t_1 v_t_2) = (lookup_total (context__TYPES v_C) v_x)) -> Instr_ok v_C (instr__CALL_INDIRECT v_x) (functype__ (@app _ v_t_1 [(valtype__INN (inn__I32 ))]) v_t_2)
	| Instr_ok__return : forall (v_C : context) (v_t_1 : (list valtype)) (v_t : (option valtype)) (v_t_2 : (list valtype)), ((Some v_t) = (context__RETURN v_C)) -> Instr_ok v_C (instr__RETURN ) (functype__ (@app _ v_t_1 v_t) v_t_2)
	...
	| Instr_ok__local_get : forall (v_C : context) (v_x : idx) (v_t : valtype), (v_x < (List.length (context__LOCALS v_C))) /\ (v_t = (lookup_total (context__LOCALS v_C) v_x)) -> Instr_ok v_C (instr__LOCAL_GET v_x) (functype__ [] [v_t])
	| Instr_ok__local_set : forall (v_C : context) (v_x : idx) (v_t : valtype), (v_x < (List.length (context__LOCALS v_C))) /\ (v_t = (lookup_total (context__LOCALS v_C) v_x)) -> Instr_ok v_C (instr__LOCAL_SET v_x) (functype__ [v_t] [])
	| Instr_ok__local_tee : forall (v_C : context) (v_x : idx) (v_t : valtype), (v_x < (List.length (context__LOCALS v_C))) /\ (v_t = (lookup_total (context__LOCALS v_C) v_x)) -> Instr_ok v_C (instr__LOCAL_TEE v_x) (functype__ [v_t] [v_t])
	| Instr_ok__global_get : forall (v_C : context) (v_x : idx) (v_t : valtype) (v_mut : mut), (v_x < (List.length (context__GLOBALS v_C))) /\ ((globaltype__ v_mut v_t) = (lookup_total (context__GLOBALS v_C) v_x)) -> Instr_ok v_C (instr__GLOBAL_GET v_x) (functype__ [] [v_t])
	| Instr_ok__global_set : forall (v_C : context) (v_x : idx) (v_t : valtype), (v_x < (List.length (context__GLOBALS v_C))) /\ ((globaltype__ (mut__MUT (Some tt)) v_t) = (lookup_total (context__GLOBALS v_C) v_x)) -> Instr_ok v_C (instr__GLOBAL_SET v_x) (functype__ [v_t] [])
	| Instr_ok__memory_size : forall (v_C : context) (v_mt : memtype), (0 < (List.length (context__MEMS v_C))) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__MEMORY_SIZE ) (functype__ [] [(valtype__INN (inn__I32 ))])
	| Instr_ok__memory_grow : forall (v_C : context) (v_mt : memtype), (0 < (List.length (context__MEMS v_C))) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__MEMORY_GROW ) (functype__ [(valtype__INN (inn__I32 ))] [(valtype__INN (inn__I32 ))])
	| Instr_ok__load_0 : forall (v_C : context) (v_nt : valtype) (v_n : (option n)) (v_sx : (option sx)) (v_memop : memop) (v_mt : memtype) (v_inn : inn), (0 < (List.length (context__MEMS v_C))) /\ ((v_n = None) <-> (v_sx = None)) /\ ((2 ^ (memop__ALIGN v_memop)) <= ((fun_size v_nt) / 8)) /\ List.Forall (fun v_n => (((2 ^ (memop__ALIGN v_memop)) <= (v_n / 8)) /\ ((v_n / 8) < ((fun_size v_nt) / 8)))) (option_to_list v_n) /\ (v_n = None) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__LOAD_ v_nt (option_zipWith (fun v_n v_sx => ((packsize__ v_n), v_sx)) v_n v_sx) v_memop) (functype__ [(valtype__INN (inn__I32 ))] [v_nt])
	| Instr_ok__load_1 : forall (v_C : context) (v_nt : valtype) (v_n : (option n)) (v_sx : (option sx)) (v_memop : memop) (v_mt : memtype) (v_inn : inn), (0 < (List.length (context__MEMS v_C))) /\ ((v_n = None) <-> (v_sx = None)) /\ ((2 ^ (memop__ALIGN v_memop)) <= ((fun_size v_nt) / 8)) /\ List.Forall (fun v_n => (((2 ^ (memop__ALIGN v_memop)) <= (v_n / 8)) /\ ((v_n / 8) < ((fun_size v_nt) / 8)))) (option_to_list v_n) /\ ((valtype__INN v_inn) = v_nt) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__LOAD_ v_nt (option_zipWith (fun v_n v_sx => ((packsize__ v_n), v_sx)) v_n v_sx) v_memop) (functype__ [(valtype__INN (inn__I32 ))] [v_nt])
	| Instr_ok__store_0 : forall (v_C : context) (v_nt : valtype) (v_n : (option n)) (v_memop : memop) (v_mt : memtype) (v_inn : inn), (0 < (List.length (context__MEMS v_C))) /\ ((2 ^ (memop__ALIGN v_memop)) <= ((fun_size v_nt) / 8)) /\ List.Forall (fun v_n => (((2 ^ (memop__ALIGN v_memop)) <= (v_n / 8)) /\ ((v_n / 8) < ((fun_size v_nt) / 8)))) (option_to_list v_n) /\ (v_n = None) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__STORE v_nt (option_map (fun v_n => (packsize__ v_n)) (v_n)) v_memop) (functype__ [(valtype__INN (inn__I32 ));v_nt] [])
	| Instr_ok__store_1 : forall (v_C : context) (v_nt : valtype) (v_n : (option n)) (v_memop : memop) (v_mt : memtype) (v_inn : inn), (0 < (List.length (context__MEMS v_C))) /\ ((2 ^ (memop__ALIGN v_memop)) <= ((fun_size v_nt) / 8)) /\ List.Forall (fun v_n => (((2 ^ (memop__ALIGN v_memop)) <= (v_n / 8)) /\ ((v_n / 8) < ((fun_size v_nt) / 8)))) (option_to_list v_n) /\ ((valtype__INN v_inn) = v_nt) /\ (v_mt = (lookup_total (context__MEMS v_C) 0)) -> Instr_ok v_C (instr__STORE v_nt (option_map (fun v_n => (packsize__ v_n)) (v_n)) v_memop) (functype__ [(valtype__INN (inn__I32 ));v_nt] [])
...
Inductive Func_ok: context -> func -> functype -> Prop :=
	| Func_ok__ : forall (v_C : context) (v_x : idx) (v_t : (list valtype)) (v_expr : expr) (v_t_1 : (list valtype)) (v_t_2 : (option valtype)), (v_x < (List.length (context__TYPES v_C))) /\ ((functype__ v_t_1 v_t_2) = (lookup_total (context__TYPES v_C) v_x)) /\ (Expr_ok ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := (Some v_t_2) |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := [v_t_2]; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_t_1 v_t); context__LABELS := []; context__RETURN := None |} ++ v_C))) v_expr v_t_2) -> Func_ok v_C (func__FUNC v_x (List.map (fun v_t => (local__LOCAL v_t)) (v_t)) v_expr) (functype__ v_t_1 v_t_2).
...
Inductive Global_ok: context -> global -> globaltype -> Prop :=
	| Global_ok__ : forall (v_C : context) (v_gt : globaltype) (v_expr : expr) (v_mut : mut) (v_t : valtype), (Globaltype_ok v_gt) /\ ((globaltype__ v_mut v_t) = v_gt) /\ (Expr_ok_const v_C v_expr (Some v_t)) -> Global_ok v_C (global__GLOBAL v_gt v_expr) v_gt.
...
Inductive Externidx_ok: context -> externidx -> externtype -> Prop :=
	| Externidx_ok__func : forall (v_C : context) (v_x : idx) (v_ft : functype), (v_x < (List.length (context__FUNCS v_C))) /\ (v_ft = (lookup_total (context__FUNCS v_C) v_x)) -> Externidx_ok v_C (externidx__FUNC v_x) (externtype__FUNC v_ft)
	| Externidx_ok__global : forall (v_C : context) (v_x : idx) (v_gt : globaltype), (v_x < (List.length (context__GLOBALS v_C))) /\ (v_gt = (lookup_total (context__GLOBALS v_C) v_x)) -> Externidx_ok v_C (externidx__GLOBAL v_x) (externtype__GLOBAL v_gt)
	| Externidx_ok__table : forall (v_C : context) (v_x : idx) (v_reserved__tt : tabletype), (v_x < (List.length (context__TABLES v_C))) /\ (v_reserved__tt = (lookup_total (context__TABLES v_C) v_x)) -> Externidx_ok v_C (externidx__TABLE v_x) (externtype__TABLE v_reserved__tt)
	| Externidx_ok__mem : forall (v_C : context) (v_x : idx) (v_mt : memtype), (v_x < (List.length (context__MEMS v_C))) /\ (v_mt = (lookup_total (context__MEMS v_C) v_x)) -> Externidx_ok v_C (externidx__MEM v_x) (externtype__MEM v_mt).
...
Inductive Step_pure: (list admininstr) -> (list admininstr) -> Prop :=
	...
	| Step_pure__trap_vals_0 : forall (v_val : (list val)) (v_instr : (list instr)), (v_val <> []) -> Step_pure (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__TRAP )] (list__instr__admininstr v_instr))) [(admininstr__TRAP )]
	| Step_pure__trap_vals_1 : forall (v_val : (list val)) (v_instr : (list instr)), (v_instr <> []) -> Step_pure (@app _ (list__val__admininstr v_val) (@app _ [(admininstr__TRAP )] (list__instr__admininstr v_instr))) [(admininstr__TRAP )]
	...
	| Step_pure__unop_val : forall (v_t : valtype) (v_c_1 : val_) (v_unop : unop_) (v_c : val_), ([(v_c : val_)] = (fun_unop v_t (v_unop : unop_) (v_c_1 : val_))) -> Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__UNOP v_t (v_unop : unop_))] [(admininstr__CONST v_t (v_c : val_))]
	...
	| Step_pure__binop_val : forall (v_t : valtype) (v_c_1 : val_) (v_c_2 : val_) (v_binop : binop_) (v_c : val_), ([(v_c : val_)] = (fun_binop v_t (v_binop : binop_) (v_c_1 : val_) (v_c_2 : val_))) -> Step_pure [(admininstr__CONST v_t (v_c_1 : val_));(admininstr__CONST v_t (v_c_2 : val_));(admininstr__BINOP v_t (v_binop : binop_))] [(admininstr__CONST v_t (v_c : val_))]
	...
	| Step_pure__cvtop_val : forall (v_t_1 : valtype) (v_c_1 : val_) (v_t_2 : valtype) (v_cvtop : cvtop) (v_sx : (option sx)) (v_c : val_), ([(v_c : val_)] = (fun_cvtop v_t_1 v_t_2 v_cvtop v_sx (v_c_1 : val_))) -> Step_pure [(admininstr__CONST v_t_1 (v_c_1 : val_));(admininstr__CVTOP v_t_2 v_cvtop v_t_1 v_sx)] [(admininstr__CONST v_t_2 (v_c : val_))]
...
Inductive Step_read_before_Step_read__call_indirect_trap: config -> Prop :=
	| Step_read__call_indirect_call_neg : forall (v_z : state) (v_i : nat) (v_x : idx) (v_a : addr), (v_i < (List.length (tableinst__REFS (fun_table v_z 0)))) /\ ((Some v_a) = (lookup_total (tableinst__REFS (fun_table v_z 0)) v_i)) /\ (v_a < (List.length (fun_funcinst v_z))) /\ ((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) -> Step_read_before_Step_read__call_indirect_trap (config__ v_z [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)]).

(* Inductive Relations Definition at: spec/wasm-1.0-test/8-reduction.watsup:7.1-7.63 *)
Inductive Step_read: config -> (list admininstr) -> Prop :=
	| Step_read__block_0 : forall (v_z : state) (v_t : (option valtype)) (v_instr : (list instr)) (v_n : n), (v_t = None) /\ (v_n = 0) -> Step_read (config__ v_z [(admininstr__BLOCK v_t v_instr)]) [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))]
	| Step_read__block_1 : forall (v_z : state) (v_t : (option valtype)) (v_instr : (list instr)) (v_n : n), (v_t <> None) /\ (v_n = 1) -> Step_read (config__ v_z [(admininstr__BLOCK v_t v_instr)]) [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))]
	...
	| Step_read__call_indirect_call : forall (v_z : state) (v_i : nat) (v_x : idx) (v_a : addr), (v_i < (List.length (tableinst__REFS (fun_table v_z 0)))) /\ ((Some v_a) = (lookup_total (tableinst__REFS (fun_table v_z 0)) v_i)) /\ (v_a < (List.length (fun_funcinst v_z))) /\ ((fun_type v_z v_x) = (funcinst__TYPE (lookup_total (fun_funcinst v_z) v_a))) -> Step_read (config__ v_z [(admininstr__CONST (valtype__INN (inn__I32 )) (v_i : val_));(admininstr__CALL_INDIRECT v_x)]) [(admininstr__CALL_ADDR v_a)]
	...
	| Step_read__call_addr : forall (v_z : state) (v_val : (list val)) (v_k : nat) (v_a : addr) (v_n : n) (v_f : frame) (v_instr : (list instr)) (v_t_1 : (list valtype)) (v_t_2 : (option valtype)) (v_mm : moduleinst) (v_func : func) (v_x : idx) (v_t : (list valtype)), (v_a < (List.length (fun_funcinst v_z))) /\ ({| funcinst__TYPE := (functype__ v_t_1 v_t_2); funcinst__MODULE := v_mm; funcinst__CODE := v_func |} = (lookup_total (fun_funcinst v_z) v_a)) /\ ((List.length v_t_1) = (List.length v_val)) /\ (v_n = (fun_optionSize v_t_2)) /\ ((func__FUNC v_x (List.map (fun v_t => (local__LOCAL v_t)) (v_t)) v_instr) = v_func) /\ (v_f = {| frame__LOCALS := (@app _ v_val (List.map (fun v_t => (fun_default_ v_t)) (v_t))); frame__MODULE := v_mm |}) -> Step_read (config__ v_z (@app _ (list__val__admininstr v_val) [(admininstr__CALL_ADDR v_a)])) [(admininstr__FRAME_ v_n v_f [(admininstr__LABEL_ v_n [] (list__instr__admininstr v_instr))])]
...
Inductive Externvals_ok: store -> externval -> externtype -> Prop :=
	| Externvals_ok__func : forall (v_S : store) (v_a : addr) (v_ext : functype) (v_minst : moduleinst) (v_code_func : func), (v_a < (List.length (store__FUNCS v_S))) /\ ({| funcinst__TYPE := v_ext; funcinst__MODULE := v_minst; funcinst__CODE := v_code_func |} = (lookup_total (store__FUNCS v_S) v_a)) -> Externvals_ok v_S (externval__FUNC v_a) (externtype__FUNC v_ext)
	| Externvals_ok__table : forall (v_S : store) (v_a : addr) (v_reserved__tt : tabletype) (v_tt' : tabletype) (v_fa : (list (option funcaddr))), (v_a < (List.length (store__TABLES v_S))) /\ ({| tableinst__TYPE := v_tt'; tableinst__REFS := v_fa |} = (lookup_total (store__TABLES v_S) v_a)) /\ (Tabletype_sub v_tt' v_reserved__tt) -> Externvals_ok v_S (externval__TABLE v_a) (externtype__TABLE v_reserved__tt)
	| Externvals_ok__mem : forall (v_S : store) (v_a : addr) (v_mt : memtype) (v_mt' : memtype) (v_b : (list byte)), (v_a < (List.length (store__MEMS v_S))) /\ ({| meminst__TYPE := v_mt'; meminst__BYTES := v_b |} = (lookup_total (store__MEMS v_S) v_a)) /\ (Memtype_sub v_mt' v_mt) -> Externvals_ok v_S (externval__MEM v_a) (externtype__MEM v_mt)
	| Externvals_ok__global : forall (v_S : store) (v_a : addr) (v_mut : mut) (v_valtype : valtype) (v_val_ : val_), (v_a < (List.length (store__GLOBALS v_S))) /\ ({| globalinst__TYPE := (globaltype__ v_mut v_valtype); globalinst__VALUE := (val__CONST v_valtype (v_val_ : val_)) |} = (lookup_total (store__GLOBALS v_S) v_a)) -> Externvals_ok v_S (externval__GLOBAL v_a) (externtype__GLOBAL (globaltype__ v_mut v_valtype)).
...
Inductive Memory_instance_ok: store -> meminst -> memtype -> Prop :=
	| Memory_instance_ok__ : forall (v_S : store) (v_mt : memtype) (v_b : (list byte)) (v_n : n) (v_m : m), (Memtype_ok v_mt) /\ ((limits__ v_n v_m) = v_mt) -> Memory_instance_ok v_S {| meminst__TYPE := v_mt; meminst__BYTES := v_b |} v_mt.
...
Inductive Table_instance_ok: store -> tableinst -> tabletype -> Prop :=
	| Table_instance_ok__ : forall (v_S : store) (v_reserved__tt : tabletype) (v_fa : (list (option funcaddr))) (v_n : n) (v_m : m) (v_functype : (list (option functype))), (Tabletype_ok v_reserved__tt) /\ List.Forall2 (fun v_fa v_functype => List.Forall2 (fun v_fa v_functype => (Externvals_ok v_S (externval__FUNC v_fa) (externtype__FUNC v_functype))) (option_to_list v_fa) (option_to_list v_functype)) (v_fa) (v_functype) /\ ((limits__ v_n v_m) = v_reserved__tt) /\ ((List.length v_fa) = (List.length v_functype)) /\ List.Forall2 (fun v_fa v_functype => ((v_fa = None) <-> (v_functype = None))) (v_fa) (v_functype) -> Table_instance_ok v_S {| tableinst__TYPE := v_reserved__tt; tableinst__REFS := v_fa |} v_reserved__tt.
...
Inductive Global_instance_ok: store -> globalinst -> globaltype -> Prop :=
	| Global_instance_ok__ : forall (v_S : store) (v_gt : globaltype) (v_v : val) (v_mut : mut) (v_vt : valtype), (Globaltype_ok v_gt) /\ ((globaltype__ v_mut v_vt) = v_gt) /\ (Val_ok v_v v_vt) -> Global_instance_ok v_S {| globalinst__TYPE := v_gt; globalinst__VALUE := v_v |} v_gt.
...
Inductive Module_instance_ok: store -> moduleinst -> context -> Prop :=
	| Module_instance_ok__ : forall (v_S : store) (v_functype : (list functype)) (v_funcaddr : (list funcaddr)) (v_globaladdr : (list globaladdr)) (v_tableaddr : (list tableaddr)) (v_memaddr : (list memaddr)) (v_exportinst : (list exportinst)) (v_functype' : (list functype)) (v_globaltype : (list globaltype)) (v_tabletype : (list tabletype)) (v_memtype : (list memtype)), List.Forall (fun v_functype => (Functype_ok v_functype)) (v_functype) /\ List.Forall (fun v_exportinst => (Export_instance_ok v_S v_exportinst)) (v_exportinst) /\ List.Forall2 (fun v_funcaddr v_functype' => (Externvals_ok v_S (externval__FUNC v_funcaddr) (externtype__FUNC v_functype'))) (v_funcaddr) (v_functype') /\ List.Forall2 (fun v_globaladdr v_globaltype => (Externvals_ok v_S (externval__GLOBAL v_globaladdr) (externtype__GLOBAL v_globaltype))) (v_globaladdr) (v_globaltype) /\ List.Forall2 (fun v_memaddr v_memtype => (Externvals_ok v_S (externval__MEM v_memaddr) (externtype__MEM v_memtype))) (v_memaddr) (v_memtype) /\ List.Forall2 (fun v_tableaddr v_tabletype => (Externvals_ok v_S (externval__TABLE v_tableaddr) (externtype__TABLE v_tabletype))) (v_tableaddr) (v_tabletype) /\ ((List.length v_funcaddr) = (List.length v_functype')) /\ ((List.length v_tableaddr) = (List.length v_tabletype)) /\ ((List.length v_globaladdr) = (List.length v_globaltype)) /\ ((List.length v_memaddr) = (List.length v_memtype)) -> Module_instance_ok v_S {| moduleinst__TYPES := v_functype; moduleinst__FUNCS := v_funcaddr; moduleinst__GLOBALS := v_globaladdr; moduleinst__TABLES := v_tableaddr; moduleinst__MEMS := v_memaddr; moduleinst__EXPORTS := v_exportinst |} {| context__TYPES := v_functype; context__FUNCS := v_functype'; context__GLOBALS := v_globaltype; context__TABLES := v_tabletype; context__MEMS := v_memtype; context__LOCALS := []; context__LABELS := []; context__RETURN := None |}.
...
Inductive Frame_ok: store -> frame -> context -> Prop :=
	| Frame_ok__ : forall (v_S : store) (v_val : (list val)) (v_moduleinst : moduleinst) (v_C : context) (v_t : (list valtype)), (Module_instance_ok v_S v_moduleinst v_C) /\ List.Forall2 (fun v_t v_val => (Val_ok v_val v_t)) (v_t) (v_val) /\ ((List.length v_t) = (List.length v_val)) -> Frame_ok v_S {| frame__LOCALS := v_val; frame__MODULE := v_moduleinst |} ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := v_t; context__LABELS := []; context__RETURN := None |} ++ v_C).
...
Inductive Global_extension: globalinst -> globalinst -> Prop :=
	| Global_extension___0 : forall (v_mut : mut) (v_t2 : valtype) (v_c1 : val_) (v_c2 : val_), (v_mut = (mut__MUT (Some tt))) -> Global_extension {| globalinst__TYPE := (globaltype__ v_mut v_t2); globalinst__VALUE := (val__CONST v_t2 (v_c1 : val_)) |} {| globalinst__TYPE := (globaltype__ v_mut v_t2); globalinst__VALUE := (val__CONST v_t2 (v_c2 : val_)) |}
	| Global_extension___1 : forall (v_mut : mut) (v_t2 : valtype) (v_c1 : val_) (v_c2 : val_), ((v_c1 : val_) = (v_c2 : val_)) -> Global_extension {| globalinst__TYPE := (globaltype__ v_mut v_t2); globalinst__VALUE := (val__CONST v_t2 (v_c1 : val_)) |} {| globalinst__TYPE := (globaltype__ v_mut v_t2); globalinst__VALUE := (val__CONST v_t2 (v_c2 : val_)) |}.
