...
Inductive Step: config -> config -> Prop :=
	...
	| Step__ctxt_frame : forall (v_s : store) (v_f : frame) (v_n : n) (v_f' : frame) (v_admininstr : (list admininstr)) (v_s' : store) (v_admininstr' : (list admininstr)), (Step (config__ (state__ v_s v_f') v_admininstr) (config__ (state__ v_s' v_f') v_admininstr')) -> Step (config__ (state__ v_s v_f) [(admininstr__FRAME_ v_n v_f' v_admininstr)]) (config__ (state__ v_s' v_f) [(admininstr__FRAME_ v_n v_f' v_admininstr')])
