...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:355.1-363.73 *)
Lemma t_read_preservation : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_valtype : (list valtype)) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Step_read (config__ (state__ v_s v_f) v_admininstr) v_admininstr') -> ((Store_ok v_s) -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> (forall (v_i : nat), (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr (functype__ v_valtype_1 v_valtype_2)) -> (Admin_instrs_ok v_s v_C' v_admininstr' (functype__ v_valtype_1 v_valtype_2)))))))).
Proof. Admitted.

(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:365.1-376.74 *)
Lemma t_preservation_type : forall (v_s : store) (v_f : frame) (v_admininstr : (list admininstr)) (v_s' : store) (v_f' : frame) (v_admininstr' : (list admininstr)) (v_C : context) (v_C' : context) (v_valtype : (list valtype)) (v_valtype_1 : (list valtype)) (v_valtype_2 : (list valtype)) (v_lab : (list resulttype)) (v_ret : (option resulttype)), ((Step (config__ (state__ v_s v_f) v_admininstr) (config__ (state__ v_s' v_f') v_admininstr')) -> ((Store_ok v_s) -> ((Store_ok v_s') -> ((Store_extension v_s v_s') -> ((Module_instance_ok v_s (frame__MODULE v_f) v_C) -> ((Module_instance_ok v_s' (frame__MODULE v_f) v_C) -> (forall (v_i : nat), (Val_ok (lookup_total (frame__LOCALS v_f) v_i) (lookup_total v_valtype v_i)) -> ((v_C' = ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := v_lab; context__RETURN := None |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := []; context__LABELS := []; context__RETURN := v_ret |} ++ ({| context__TYPES := []; context__FUNCS := []; context__GLOBALS := []; context__TABLES := []; context__MEMS := []; context__LOCALS := (@app _ v_valtype (context__LOCALS v_C)); context__LABELS := []; context__RETURN := None |} ++ v_C)))) -> ((Admin_instrs_ok v_s v_C' v_admininstr (functype__ v_valtype_1 v_valtype_2)) -> (Admin_instrs_ok v_s' v_C' v_admininstr' (functype__ v_valtype_1 v_valtype_2))))))))))).
Proof. Admitted.

(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:379.1-383.45 *)
...
(* Lemma Definition at: spec/wasm-1.0-test/A-soundness.watsup:386.1-392.39 *)
