...
(* Theorem Definition at: spec/wasm-1.0-test/A-soundness.watsup:378.1-382.33 *)
Theorem t_preservation : forall (v_config_1 : config) (v_rt : resulttype) (v_config_2 : config), ((Step v_config_1 v_config_2) -> ((Config_ok v_config_1 v_rt) -> (Config_ok v_config_2 v_rt))).
Proof. Admitted.
